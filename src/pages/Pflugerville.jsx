...
const mapEmbed = (label) =>
  `https://www.google.com/maps?q=${encodeURIComponent(label)}&t=k&z=13&output=embed`

const FAQS = [
  {
    q: 'What types of vape products do you offer to customers in Pflugerville?',
    a: 'We carry disposable vapes, vape mods, coils, pods, and a wide range of e-juices from trusted brands — everything Pflugerville vapers need, in store or online.',
  },
  {
  ...
  {
    q: 'Do you serve areas in Central Texas outside of Pflugerville?',
    a: 'Absolutely. Along with Pflugerville, we proudly serve Round Rock, Georgetown, Cedar Park, Hutto, Kyle Buda, San Marcos, Waco, and Taylor.',
  },
  {
    ...
    <>
      <section className="container-x pt-6">
        <nav className="flex items-center gap-2 text-xs text-neutral-500">
          ...
          <span>/</span>
          <span className="font-semibold text-ink">Pflugerville</span>
        </nav>
      </section>

      <section className="relative mt-6 h-[360px] w-full overflow-hidden bg-ink sm:h-[440px] lg:h-[500px]">
        <img src={vapeDevices} alt="Pflugerville smoke and vape shop" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <h1 className="max-w-3xl font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Pflugerville&rsquo;s Original Smoke &amp; Vape Shop
          </h1>
          <p className="mt-4 max-w-2xl text-sm text-neutral-200 sm:text-base">
            Looking for a reliable smoke shop right here in Pflugerville? Triple Buzz Smoke Shop, located at{' '}
            {siteConfig.address}, is the original home of premium vapes, high-quality glassware, top-tier
            pre-rolls, and essential hardware. Whether you&rsquo;re near Lake Pflugerville or commuting down
            Toll 130, our team is dedicated to providing Pflugerville residents with the absolute best
            selection, fair pricing, and expert knowledge for all your smoke and vape needs.
          </p>
          <Link
            to="/shop"
      ...
      <section className="container-x py-14">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="h-64 overflow-hidden rounded-md border border-neutral-200 lg:h-80">
            <iframe
              title="Triple Buzz Smoke Shop, Pflugerville, TX"
              src={mapEmbed(`${siteConfig.name} Smoke Shop, ${siteConfig.address}`)}
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              supply Pflugerville vapers with an extensive inventory of top-shelf vape juices, disposable
              ...
              switch and experienced vapers searching for the newest hardware upgrades in Travis County.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              seamless session. We pride ourselves on offering Pflugerville residents safe, high-quality
              options, ensuring you never have to settle for sub-par accessories or sketchy gas station
              alternatives again.
            </p>
          </div>
          <div className="order-1 h-64 overflow-hidden rounded-md border border-neutral-200 lg:order-2 lg:h-80">
            <iframe
              title="Lake Pflugerville, TX satellite view"
              src={mapEmbed('Lake Pflugerville, Texas')}
              className="h-full w-full border-0"
              referrerPolicy="no-referrer-when-downgrade"
            />
          </div>
