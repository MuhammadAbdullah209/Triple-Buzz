  ...
  return (
    <>
      ...
      <section className="container-x py-10">
        <div className="mx-auto flex max-w-3xl flex-col gap-4 text-sm leading-relaxed">
          ...
          <p className="text-purple-600">By using our site, you consent to our Privacy Policy.</p>
        </div>
      </section>
