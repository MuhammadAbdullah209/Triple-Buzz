...
const FAQS = [
  {
    q: 'What types of vape products do you offer to customers in Waco?',
    a: 'We carry disposable vapes, vape mods, coils, pods, and a wide range of e-juices from trusted brands — everything Waco vapers need, whether you shop in person or browse online.',
  },
  {
  ...
  {
    q: 'Do you serve areas in Central Texas outside of Waco?',
    a: 'Absolutely. Along with Waco, we proudly serve Pflugerville, Round Rock, Georgetown, Cedar Park, Hutto, Kyle Buda, San Marcos, and Taylor.',
  },
  {
    ...
    <>
      <section className="container-x pt-6">
        <nav className="flex items-center gap-2 text-xs text-neutral-500">
          ...
          <span>/</span>
          <span className="font-semibold text-ink">Waco</span>
        </nav>
      </section>

      <section className="relative mt-6 h-[360px] w-full overflow-hidden bg-ink sm:h-[440px] lg:h-[500px]">
        <img src={vapeDevices} alt="Waco smoke and vape shop" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <h1 className="max-w-3xl font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Waco&rsquo;s Go-To Smoke &amp; Vape Shop
          </h1>
          <p className="mt-4 max-w-2xl text-sm text-neutral-200 sm:text-base">
            Looking for a reliable smoke shop right here in Waco? Triple Buzz Smoke brings premium vapes,
            high-quality glassware, top-tier pre-rolls, and essential hardware straight to the local community.
            Whether you&rsquo;re hanging out near the Silos or commuting down I-35, our team is dedicated to
            providing Waco residents with the absolute best selection, fair pricing, and expert knowledge for
            all your smoke and vape needs.
          </p>
          <Link
            to="/shop"
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              supply Waco vapers with an extensive inventory of top-shelf vape juices, disposable vapes, and
              ...
              switch and experienced vapers searching for the newest hardware upgrades in McLennan County.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              seamless session. We pride ourselves on offering Waco residents safe, high-quality options,
