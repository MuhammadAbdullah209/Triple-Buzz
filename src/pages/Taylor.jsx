...
const FAQS = [
  {
    q: 'What types of vape products do you offer to customers in Taylor?',
    a: 'We carry disposable vapes, vape mods, coils, pods, and a wide range of e-juices from trusted brands — everything Taylor vapers need, whether you shop in person or browse online.',
  },
  {
  ...
  {
    q: 'Do you serve areas in Central Texas outside of Taylor?',
    a: 'Absolutely. Along with Taylor, we proudly serve Pflugerville, Round Rock, Georgetown, Cedar Park, Hutto, Kyle Buda, San Marcos, and Waco.',
  },
  {
    ...
    <>
      <section className="container-x pt-6">
        <nav className="flex items-center gap-2 text-xs text-neutral-500">
          ...
          <span>/</span>
          <span className="font-semibold text-ink">Taylor</span>
        </nav>
      </section>

      <section className="relative mt-6 h-[360px] w-full overflow-hidden bg-ink sm:h-[440px] lg:h-[500px]">
        <img src={vapeDevices} alt="Taylor smoke and vape shop" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <h1 className="max-w-3xl font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Taylor&rsquo;s Go-To Smoke &amp; Vape Shop
          </h1>
          <p className="mt-4 max-w-2xl text-sm text-neutral-200 sm:text-base">
            Looking for a reliable smoke shop right here in Taylor? Triple Buzz Smoke brings premium vapes,
            high-quality glassware, top-tier pre-rolls, and essential hardware straight to the local community.
            Whether you&rsquo;re hanging out near Dinosaur Park or commuting down Highway 79, our team is
            dedicated to providing Taylor residents with the absolute best selection, fair pricing, and expert
            knowledge for all your smoke and vape needs.
          </p>
          <Link
            to="/shop"
      ...
      <section className="container-x py-14">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="h-64 overflow-hidden rounded-md border border-neutral-200 lg:h-80">
            <iframe
              title="Taylor, TX aerial view"
              src={mapEmbed('Taylor, Texas')}
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              supply Taylor vapers with an extensive inventory of top-shelf vape juices, disposable vapes, and
              the latest coils and pods. We understand that hardware needs to be reliable, which is why we
              ...
              switch and experienced vapers searching for the newest hardware upgrades in Williamson County.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-600">
              ...
              seamless session. We pride ourselves on offering Taylor residents safe, high-quality options,
          ...
          <div className="order-1 h-64 overflow-hidden rounded-md border border-neutral-200 lg:order-2 lg:h-80">
            <iframe
              title="Taylor, TX satellite view"
              src={mapEmbed('The Dinosaur Park, 893 Union Chapel Rd, Taylor, TX')}
              className="h-full w-full border-0"
              referrerPolicy="no-referrer-when-downgrade"
            />
          </div>
